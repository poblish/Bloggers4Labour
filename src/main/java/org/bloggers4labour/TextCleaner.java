...
//		String	s = "<a href=\"http://www.marxists.org/archive/mariateg/bio/index.htm\">Jose Carlos Marietegui</a>, Peruvian socialist; born 1894, died 16 April 1930.</div>";
	...
	private String _handleEntities( String inStr, boolean inHTML)
	{
		if (!inHTML)
		{
			return s_eAcutePattern.matcher(
					s_PoundPattern.matcher(inStr).replaceAll("\u00A3") ).replaceAll("");
		}
